...
#define END_EFFECTOR_OFFSET 60.0 // LENGTH FROM UPPER SHANK BEARING TO MIDPOINT OF END EFFECTOR IN MM
...
#define X_HOME_STEPS 575 //380 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM

#define Y_HOME_STEPS 1575 //1490 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM

//#define Z_HOME_STEPS 3500 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER
...
#define Z_MIN_INPUT 1 // OUTPUT VALUE WHEN SWITCH ACTIVATED - NO: 0, NC: 1
